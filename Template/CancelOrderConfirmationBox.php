<div class="" id="confirmationBox" style="width:100%;background: white;">
    <div class="row py-3 mx-auto cart-product-card p-0" style="position: relative; border-radius: 5px 5px 0 0; width:100%">
        ...
        <div class="col-xl-3 col-lg-2 col-md-4 col-sm-4 col-4 d-flex justify-content-center">
            <img src="trialimage/007.jpg" class="img-fluid cart-img" alt="" style="width: 66px;" class="ModalProductImgae" id="ModalProductImgae">
        </div>
    ...
    <form method="post">
        <div class="row mx-auto pt-1 cart-product-card" style=" border-radius: 0 0 5px 5px;  width:100%">
            ...
            <div class="col-4 text-center ml-2 mb-2 border-top p-0"><button type="submit" id="sureDeleteFromCart" name="sureCancelOrder" class=" btn px-3 border-right shadow-none" style="width: 100%; height:100%; font-size:1.05rem; font-weight: 600; color:#6e6e6e;">CANCEL ORDER</button></div>
            <div class="col text-center border-top mb-2 mr-2 p-0"><button type="submit" id="waitForDelivery" name="waitForDelivery" class="btn shadow-none" style="width: 100%; height:100%; font-size:1.05rem; font-weight: 600; color:tomato">WAIT FOR DELIVERY</button></div>
        </div>
    </form>
</div>